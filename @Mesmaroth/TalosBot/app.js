...
bot.on('guildMemberAdd', guildMember =>{
	...
	generalChannel.send("<@" + bot.user.id + ">, welcome to **" + guildMember.guild.name + 
  		...
  		mChannel.send("**About**", {
	  		embed:{
	  			...
	  			fields:[{
	  				...
	  				name: "Source",
	  				value: "https://github.com/Kernelization/Bots/tree/master/%40Mesmaroth",
	  				inline: false
	  			},{
	  				name: "** **",
	  				value: "A version of AkephalosBot: https://github.com/Mesmaroth/discord-AkephalosBot",
	  				inline: false
	  			}]	  			
	  		}
  		}).catch(error =>{
